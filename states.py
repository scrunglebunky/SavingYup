...
class Play(Template):
    ...
    def __init__(self,
        ...
        self.priority=["title","pause","options","gameover","advance","newlevel","lore","shop","gameplay","gameplayui"]
        self.queue_started = False # the queue doesn't do anything if this isn't true
        # adding items to queue
        # self.add_queue('shop')
        # self.add_queue('lore')
        self.add_queue('title')
        ...
        self.title = Title(self) #creating a NEWLEVEL asset that plays with every new level
